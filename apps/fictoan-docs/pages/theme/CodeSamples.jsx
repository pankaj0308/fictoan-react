//  Code sample 01 ////////////////////////////////////////////////////////////
export const sampleThemeGlobals = `globals : {
    borderWidth : "1px"
}`;


//  Code sample 01 ////////////////////////////////////////////////////////////
export const sampleThemeBasics = `body : {
    bg : defaultColours.white,
}`;


//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeBreadcrumbs = `breadcrumbs : {
    wrapper : {
        bg : defaultColours.white,
    },
    item : {
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeButton = `button : {
    font        : "sans-serif",
    isLoading : {
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeCard = `card : {
    bg           : defaultColours.white,
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeHRule = `hr : {
    primary : {
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeInput = `input : {
    default : {
        bg           : defaultColours.white,
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeInfoPanel = `infoPanel : {
    bg     : defaultColours.white,
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeNotification = `notification : {
    default : {
        bg   : defaultColours.slate10,
        text : customColours.shade
    },
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeProgressBar = `progressBar : {
    bg     : defaultColours.slate20,
    fill   : customColours.hue,
    label  : customColours.shade,
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeSidebar = `sidebar : {
    isCollapsed : {
        label : {
            text : defaultColours.white,
            bg   : customColours.hue
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeTable = `table : {
    bg      : defaultColours.white,
    text    : customColours.shade,
    border  : defaultColours.slate40,
    striped : {
...
//  Code sample 02 ////////////////////////////////////////////////////////////
export const sampleThemeTabs = `tabs : {
    label : {
        default : {
...
//  Code sample 01 ////////////////////////////////////////////////////////////
export const sampleThemeText = `text : {
    font : {
        sans  : "sans-serif",
        serif : "serif",
        mono  : "monospace",
